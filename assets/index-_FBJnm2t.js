...
L.cloneElement = function (e, t, n) {
  ...
  return { $$typeof: Kn, type: e.type, key: l, ref: o, props: r, _owner: i };
};
...
function $c(e, t, n, r, l, o, i, u, s) {
  (Sn = !1), (Tr = null), Fc.apply(Uc, arguments);
}
function Vc(e, t, n, r, l, o, i, u, s) {
  if (($c.apply(this, arguments), Sn)) {
    if (Sn) {
      var c = Tr;
      (Sn = !1), (Tr = null);
...
var ln = {
  ...
  jl = we(sf),
  af = H({}, ln, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  cf = we(af),
  ff = H({}, ln, {
...
var yf = H({}, Zn, {
  ...
  Sf = we(kf),
  Cf = H({}, ln, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Ef = we(Cf),
  _f = H({}, nl, {
    deltaX: function (e) {
...
function au(e, t, n, r, l) {
  for (var o = t._reactName, i = []; n !== null && n !== r; ) {
    ...
    u.tag === 5 &&
      ...
      ((u = c),
      l
        ? ((s = Rn(n, o)), s != null && i.unshift($n(n, s, u)))
        : l || ((s = Rn(n, o)), s != null && i.push($n(n, s, u)))),
      (n = n.return);
  }
...
function mt() {
  if (!Dl && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), Es(Zo, mt), l);
    } finally {
      (M = t), (Dl = !1);
    }
  }
...
function Eo(e, t, n, r) {
  var l = e.stateNode;
  (l.props = n), (l.state = e.memoizedState), (l.refs = oa), di(e);
  var o = t.contextType;
  typeof o == "object" && o !== null
    ? (l.context = Ee(o))
...
function gi(e, t, n, r, l, o) {
  if (
    ...
    o = 0;
    do {
      if (((Nn = !1), (Bn = 0), 25 <= o)) throw Error(y(301));
      (o += 1),
        (Z = K = null),
        (t.updateQueue = null),
        (Er.current = od),
  ...
  rd = {
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        ...
        (r.flags |= 2048),
        Qn(9, pa.bind(null, r, o, n, t), void 0, null),
        n
      );
    },
    useId: function () {
...
function Pu(e, t, n, r, l) {
  ...
  if ((Yt(t, l), t.stateNode === null))
    Nr(e, t), ia(t, n, r), Eo(t, n, r, l), (r = !0);
  else if (e === null) {
    var i = t.stateNode,
      u = t.memoizedProps;
    i.props = u;
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || $.current & 1 ? Y === 0 && (Y = 3) : ji())),
          t.updateQueue !== null && (t.flags |= 4),
          ne(t),
          null);
    case 4:
      return (
        en(), Lo(e, t), e === null && Un(t.stateNode.containerInfo), ne(t), null
      );
    case 10:
...
function Va(e) {
  ...
  t !== null && ((e.alternate = null), Va(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[De], delete t[Vn], delete t[yo], delete t[Xf], delete t[Zf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Re(e, t, n, r) {
  if (50 < Pn) throw ((Pn = 0), (Do = null), Error(y(185)));
  Xn(e, n, r),
    (!(R & 2) || e !== J) &&
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = go(yt.bind(null, e, ae, $e), t);
            break;
          }
          yt(e, ae, $e);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = go(yt.bind(null, e, ae, $e), r);
            break;
          }
          yt(e, ae, $e);
          break;
...
ys = _i;
ws = zt;
var Pd = { usingClientEntryPoint: !1, Events: [Jn, Ft, ol, vs, gs, _i] },
  vn = {
  ...
  Ld = {
    ...
    findFiberByHostInstance: vn.findFiberByHostInstance || jd,
      ...
      children: [
        ...
        v.jsxs("div", {
          ...
          children: [
            v.jsx("div", {
              className:
                "w-64 h-64 md:w-96 md:h-96 border-t-4 border-l-4 border-r-4 rounded-t-full overflow-hidden shadow-lg",
              children: v.jsx("img", {
    ...
    v.jsx("div", {
      ...
      children: v.jsxs("div", {
        ...
        children: [
          v.jsx("h1", {
            className:
              "text-center font-extrabold text-6xl capitalize text-[#e4ff45]",
            children: "Testimonial",
          }),
          v.jsxs("div", {
            className: "mt-12 pt-12 grid grid-cols-2",
            children: [
              v.jsx("div", {
                children: e[0].map((t) =>
                  v.jsx(
                    "div",
                    {
                      className: "rounded-xl mb-8 mr-8",
                      children: v.jsxs("div", {
...
Ql.createRoot(document.getElementById("root")).render(
  v.jsx(xc.StrictMode, { children: v.jsx(Kd, {}) })
);
