...
function Ac(e, t, n, r, l, i, o, u, s) {
  (Cn = !1), (Tr = null), $c.apply(Vc, arguments);
}
...
var on = {
  ...
  _l = we(ad),
  cd = A({}, on, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  dd = we(cd),
  fd = A({}, on, {
...
var wd = A({}, Zn, {
  ...
  Cd = we(Sd),
  Ed = A({}, on, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Nd = we(Ed),
  jd = A({}, nl, {
    deltaX: function (e) {
...
var zd = We && "TextEvent" in window && !En,
  Os = We && (!no || (En && 8 < En && 11 >= En)),
  bo = " ",
  eu = !1;
function Fs(e, t) {
  switch (e) {
        ...
        for (var a = c, f; a !== null; ) {
          ...
          if (
            (f.tag === 5 &&
              g !== null &&
              ((f = g),
              d !== null && ((g = Mn(a, d)), g != null && k.push(Vn(a, g, f)))),
            F)
          )
            break;
          a = a.return;
...
var un = Math.random().toString(36).slice(2),
  ...
  gi = "__reactEvents$" + un,
  Zd = "__reactListeners$" + un,
  Jd = "__reactHandles$" + un;
function wt(e) {
  var t = e[Oe];
  if (t) return t;
...
function ua(e) {
      ...
      : a !== null &&
        (a.elementType === C ||
          (typeof C == "object" &&
            ...
            C.$$typeof === Ze &&
            ku(C) === a.type))
      ? ((g = l(a, f.props)), (g.ref = hn(d, a, f)), (g.return = d), g)
  ...
  function p(d, a, f, g) {
    ...
    if (typeof f == "object" && f !== null) {
      ...
      if (wn(f) || cn(f)) return C !== null ? null : v(d, a, f, g, null);
      pr(d, f);
    }
    return null;
  }
  function w(d, a, f, g, C) {
    ...
    if (typeof g == "object" && g !== null) {
      ...
      if (wn(g) || cn(g)) return (d = d.get(f) || null), v(a, d, g, C, null);
      pr(a, g);
    }
    return null;
  }
  ...
  function F(d, a, f, g) {
    if (
      ...
      if (wn(f)) return x(d, a, f, g);
      if (cn(f)) return k(d, a, f, g);
      pr(d, f);
    }
...
function go(e, t, n, r, l, i) {
  if (
    ...
    i = 0;
    do {
      if (((_n = !1), (Wn = 0), 25 <= i)) throw Error(y(301));
      (i += 1),
        (Z = K = null),
        (t.updateQueue = null),
        (Er.current = uf),
...
function Va(e) {
  ...
  t !== null && ((e.alternate = null), Va(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Oe], delete t[An], delete t[gi], delete t[Zd], delete t[Jd])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
var Tf = { usingClientEntryPoint: !1, Events: [Jn, Ft, il, vs, gs, No] },
  ...
  Rf = {
    ...
    findFiberByHostInstance: gn.findFiberByHostInstance || zf,
...
const rc =
  ...
  Xf = ({ title: e, link: t, description: n, skills: r }) => {
    const [l, i] = ln.useState(!1);
    return m.jsx(m.Fragment, {
      children: m.jsx("div", {
        className: "relative mb-12",
        children: m.jsxs("div", {
          className:
            "relative z-10 mx-7 rounded-[20px] bg-[#e4ff45] text-black py-[34px] px-3 text-center shadow-portfolio dark:shadow-box-dark h-full",
          children: [
            m.jsx("h3", {
            ...
            r
              ...
              .map((o) =>
                m.jsx("span", {
                  className:
                    "bg-black text-[#e4ff45] hover:border-primary hover:bg-primary inline-block rounded-md border border-black py-[3px] px-3 m-[2px] text-sm font-medium transition",
                  children: o,
                })
              ),
