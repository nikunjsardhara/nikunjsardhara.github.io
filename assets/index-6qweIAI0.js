...
function Ac(e, t, n, r, l, i, o, u, s) {
  (Sn = !1), (Tr = null), Uc.apply($c, arguments);
}
...
function fn(e, t) {
  e.blockedOn === t &&
    ...
    ai ||
      ((ai = !0),
      ge.unstable_scheduleCallback(ge.unstable_NormalPriority, nd)));
}
function Dn(e) {
  function t(l) {
    return fn(l, e);
...
function qi(e, t, n, r) {
  if (Dr) {
    var l = ci(e, t, n, r);
    if (l === null) Il(e, t, r, Or, n), Go(e, r);
    else if (td(l, e, t, n, r)) r.stopPropagation();
    else if ((Go(e, r), t & 4 && -1 < ed.indexOf(e))) {
      for (; l !== null; ) {
        var i = Jn(l);
        if (
          (i !== null && zs(i),
...
var ln = {
  ...
  ud = we(od),
  sd = V({}, Zn, { relatedTarget: 0 }),
  _l = we(sd),
  ad = V({}, ln, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  cd = we(ad),
  dd = V({}, ln, {
...
var yd = V({}, Zn, {
  ...
  Sd = we(kd),
  Cd = V({}, ln, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Ed = we(Cd),
  Nd = V({}, nl, {
    deltaX: function (e) {
...
var Pd = We && "TextEvent" in window && !Cn,
...
function ru() {
  En && (En.detachEvent("onpropertychange", Vs), (On = En = null));
}
function Vs(e) {
...
function Id(e, t, n) {
  e === "focusin"
    ? (ru(), (En = t), (On = n), En.attachEvent("onpropertychange", Vs))
    : e === "focusout" && ru();
}
function Dd(e) {
...
ft(Ks, "onAnimationIteration");
ft(Gs, "onAnimationStart");
...
var xn =
  ...
  Hd = new Set("cancel close invalid load scroll toggle".split(" ").concat(xn));
function su(e, t, n) {
  ...
  if (!e[cr]) {
    (e[cr] = !0),
      ls.forEach(function (n) {
        n !== "selectionchange" && (Hd.has(n) || Rl(n, !1, e), Rl(n, !0, e));
      });
        ...
        for (var a = c, f; a !== null; ) {
          ...
          if (
            (f.tag === 5 &&
              g !== null &&
              ((f = g),
              d !== null && ((g = Mn(a, d)), g != null && k.push($n(a, g, f)))),
            F)
          )
            break;
          a = a.return;
...
function au(e, t, n, r, l) {
  for (var i = t._reactName, o = []; n !== null && n !== r; ) {
    ...
    u.tag === 5 &&
      ...
      ((u = c),
      l
        ? ((s = Mn(n, i)), s != null && o.unshift($n(n, s, u)))
        : l || ((s = Mn(n, i)), s != null && o.push($n(n, s, u)))),
      (n = n.return);
  }
...
function ea(e, t, n) {
  (xe[ke++] = Ve), (xe[ke++] = Be), (xe[ke++] = Nt), (Nt = e);
  var r = Ve;
  e = Be;
  var l = 32 - Te(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
var qd = Ye.ReactCurrentBatchConfig;
function Pe(e, t) {
  if (e && e.defaultProps) {
  ...
  function m(d, a, f, g) {
    ...
    if (typeof f == "object" && f !== null) {
      switch (f.$$typeof) {
        ...
        case Ze:
          return (C = f._init), m(d, a, C(f._payload), g);
      }
...
function po(e, t) {
  switch ((I(Bn, t), I(Vn, e), I(Ue, qn), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function $l(e) {
  ...
  if (((e = n.interleaved), e !== null)) {
    l = e;
    do (i = l.lane), (A.lanes |= i), (_t |= i), (l = l.next);
    while (l !== e);
...
function Ea(e, t, n) {
  return jt & 21
    ? (Re(n, t) || ((n = _s()), (A.lanes |= n), (_t |= n), (e.baseState = !0)),
      t)
...
function nf(e, t, n) {
  ...
  if (ja(e)) _a(t, l);
    ...
    (n = ra(e, t, l, r)),
      n !== null && ((l = oe()), Me(n, e, r, l), Pa(n, t, r));
  }
}
function ja(e) {
  var t = e.alternate;
    ...
    case 5:
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = kt(Ue.current)), fr(t))) {
          ...
          switch (((r[Oe] = t), (r[An] = i), (e = (t.mode & 1) !== 0), n)) {
            case "dialog":
...
function Aa(e) {
  ...
  t !== null && ((e.alternate = null), Aa(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Oe], delete t[An], delete t[gi], delete t[Xd], delete t[Zd])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Me(e, t, n, r) {
  ...
  Xn(e, n, r),
    (!(M & 2) || e !== J) &&
      (e === J && (!(M & 2) && (cl |= n), Y === 4 && be(e, b)),
      pe(e, r),
      n === 1 && M === 0 && !(t.mode & 1) && ((nn = Q() + 500), ol && mt()));
}
function pe(e, t) {
...
function Qa(e, t) {
  if (((_r = -1), (Pr = 0), M & 6)) throw Error(y(327));
  var n = e.callbackNode;
...
function St(e, t) {
  ...
  if ((n !== -1 && ((e.timeoutHandle = -1), Kd(n)), K !== null))
...
function qr(e, t) {
  ...
  while (!0);
  if ((so(), (M = n), (Xr.current = r), K !== null)) throw Error(y(261));
  return (J = null), (b = 0), Y;
}
function yf() {
  for (; K !== null; ) Ya(K);
...
function yt(e, t, n) {
  var r = R,
    l = Ce.transition;
  try {
    (Ce.transition = null), (R = 1), xf(e, t, n, r);
  } finally {
    (Ce.transition = l), (R = r);
  }
  return null;
  ...
  if (tt !== null) {
    ...
    try {
      if (((Ce.transition = null), (R = 16 > e ? 16 : e), tt === null))
        ...
        if (
          ((M = l), mt(), Fe && typeof Fe.onPostCommitFiberRoot == "function")
        )
          try {
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Zi(t, n | 1), pe(t, Q()), !(M & 6) && ((nn = Q() + 500), mt()));
      }
      break;
    case 13:
      Pt(function () {
...
ys = No;
ws = Pt;
var Lf = { usingClientEntryPoint: !1, Events: [Jn, Ft, il, vs, gs, No] },
  vn = {
  ...
  Tf = {
    ...
    findFiberByHostInstance: vn.findFiberByHostInstance || Pf,
...
if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
  ...
  if (!gr.isDisabled && gr.supportsFiber)
    try {
      (tl = gr.inject(Tf)), (Fe = gr);
    } catch {}
}
ye.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Lf;
...
const rc =
            ...
            children: [
              ...
              p.jsxs("span", {
                className:
                  "flex flex-row flex-nowrap gap-2 items-center justify-start",
                children: [
                  p.jsx("img", { src: rc, height: 24, width: 24 }),
                  p.jsx("a", {
              ...
              p.jsxs("span", {
                onClick: e,
                className:
                  "flex flex-row flex-nowrap gap-2 items-center justify-start cursor-pointer",
                children: [
                  p.jsx("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
                    fill: "none",
  ...
  Of = ({ title: e, content: t, isOpen: n, onClick: r }) =>
    p.jsxs("div", {
          ...
          children: [
            ...
            p.jsxs("div", {
              ...
              children: [
                ...
                p.jsx("b", { children: "web developer" }),
                " for 8 years.",
                p.jsx("br", {}),
                "I am based in ",
                p.jsx("b", { children: "India" }),
                ".",
              ],
            }),
            p.jsx("div", {
  ...
  Yf = ({ title: e, link: t, description: n, skills: r }) =>
    p.jsx(p.Fragment, {
      children: p.jsx("div", {
        ...
        children: p.jsxs("div", {
          ...
          children: [
            ...
            p.jsx("p", { className: "mt-4", children: n }),
          ],
        }),
      }),
    });
...
Ql.createRoot(document.getElementById("root")).render(
  p.jsx(kc.StrictMode, { children: p.jsx(Xf, {}) })
);
